...
%   Copyright 2018 The MathWorks, Inc.
    ...
    properties    
        ...
        %PlanningPeriod Interval for updating planned local path 
        %
        PlanningPeriod
    end
    ...
    %----------------------------------------------------------------------
    methods
        function tf = pathUpdateNeeded(obj)
            tf = isempty(obj.RefPoses) || (mod(obj.StepCount, obj.PlanningPeriod) == 0 && obj.VelocityProfile(end, 1) ~= 0);
        end
    end
