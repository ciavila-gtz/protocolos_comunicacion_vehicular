classdef V2IReceiver < matlab.System
    ...
    methods(Access = protected)
        ...
        function spatOut = stepImpl(obj,spat,distanceToTrafficLight)
            spatOut = obj.SPATOut;
            ...
            if distanceToTrafficLight<obj.MaxDist
                ...
                snrEstimate = min(max(obj.SnrMin,interp1(obj.DistanceToSnrInfo(:,1),obj.DistanceToSnrInfo(:,2),v2idist)),obj.SnrMax);
