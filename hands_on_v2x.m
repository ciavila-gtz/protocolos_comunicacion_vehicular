...
% Transpose the power matrix
rx_pow_T = rx_pow';                     % Now rows are frequency and columns are time


% Plot frequency in Y and time in X
figure;
imagesc(time, frequency, rx_pow_T);
axis xy;
xlabel('Tiempo (ms)');
...
plot(time, carrierTrajectory, 'w', 'LineWidth', 2);
